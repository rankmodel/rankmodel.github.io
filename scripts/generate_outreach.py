...
![ModelRank](https://rankmodel.github.io/badges/{model_id}/score.svg)
...
We built ModelRank (https://rankmodel.github.io), an independent composite scoring system for HuggingFace models.
...
```![ModelRank Score](https://rankmodel.github.io/badges/{model_id}/score.svg)```
