...
def main():
    ...
    if efficiency_king:
        newsletter += (
            ...
            f"({ek:.0f}/100), which shows that small, well-trained models hold their own.\n"
        )
    else:
    ...
    newsletter += (
        ...
        f"---\n*Generated by ModelRank, the independent AI leaderboard · {BASE_URL}*\n"
    )
...
<body class="min-h-screen">
  ...
  <main class="container mx-auto px-4 py-10 max-w-3xl">
    ...
    <p class="text-center text-sm text-gray-500">Independent AI leaderboard · <a href="{BASE_URL}" class="text-blue-400 hover:underline">rankmodel.github.io</a></p>
  </main>
</body>
</html>"""
