    ...
    <div class="container mx-auto px-4 max-w-7xl relative z-10">
      <nav class="flex items-center justify-between mb-16">
        ...
        <div class="flex items-center gap-6 text-sm font-medium text-gray-400">
          ...
          <a href="https://github.com/rankmodel/rankmodel" class="hover:text-white transition-colors flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16">
      <div class="glass-card p-8 rounded-2xl">
        ...
        <div class="mt-8 flex flex-wrap gap-4">
          ...
          <a href="https://github.com/rankmodel/rankmodel" class="text-sm text-blue-400 hover:text-blue-300 transition-colors">View source code &rarr;</a>
  ...
  <footer class="border-t border-white/10 bg-surface/50 mt-12 py-12">
    <div class="container mx-auto px-4 max-w-7xl flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div class="flex flex-wrap gap-6 text-sm font-medium">
        <a href="https://github.com/rankmodel/rankmodel" class="text-gray-400 hover:text-white transition-colors">GitHub</a>
...
<body class="min-h-screen bg-base-200">
  ...
  <footer class="footer items-center p-8 bg-neutral text-neutral-content">
    ...
    <nav class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
      ...
      <a href="https://github.com/rankmodel/rankmodel" class="link link-hover">GitHub</a>
        ...
        <footer class="border-t border-white/10 pt-12 pb-24 mt-24">
          <div class="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="text-right">
              ...
              <p class="text-gray-500 text-xs mt-2">Questions? Open an issue on <a href="https://github.com/rankmodel/rankmodel/issues" class="text-blue-400 hover:underline">GitHub</a></p>
            </div>
          </div>
        </footer>
...
<body class="min-h-screen">
  ...
  <main class="container mx-auto px-4 py-12 max-w-5xl">
    ...
    <div class="mt-12 text-center text-sm text-gray-500">
      ...
      <a href="https://github.com/rankmodel/rankmodel" class="text-blue-400 hover:underline">Gradio UI</a>,
  ...
  <footer class="border-t border-white/10 mt-12 py-8">
    <div class="container mx-auto px-4 max-w-5xl text-center text-sm text-gray-500">
      ...
      <a href="https://github.com/rankmodel/rankmodel" class="text-blue-400 hover:underline ml-2">GitHub</a>
    </div>
  </footer>
</body>
</html>'''
