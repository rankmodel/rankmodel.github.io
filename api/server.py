...
async def get_meta():
    ...
    return {
        'version': '2.0.0',
        'total_models': cache_size,
        'methodology_url': 'https://rankmodel.github.io/methodology.html',
        'api_docs_url': 'https://rankmodel.github.io/api.html',
        'changelog_url': 'https://rankmodel.github.io/changelog.json',
        'github_url': 'https://github.com/rankmodel/rankmodel.github.io',
    }
